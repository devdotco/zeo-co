  ...
  return (
    <div className="bg-[#0a0d0b] min-h-screen">
      ...
      <section className="py-14 border-b border-[#1e2620]">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          ...
          <div className="space-y-px">
            {/* Step 1 */}
            <div className="rounded-t-xl border border-[#1e2620] bg-[#111512] px-6 py-5">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#0a0d0b] border border-[#22c55e]/30 flex items-center justify-center">
                  <span className="text-[0.65rem] font-bold text-[#22c55e] tabular-nums">1</span>
                </div>
                <div>
                  <h3 className="text-[0.9375rem] font-semibold text-[#eef2ec] mb-1.5">Invoice submission and advance</h3>
            ...
            {/* Step 2 */}
            <div className="border-x border-b border-[#1e2620] bg-[#111512] px-6 py-5">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#0a0d0b] border border-[#22c55e]/30 flex items-center justify-center">
                  <span className="text-[0.65rem] font-bold text-[#22c55e] tabular-nums">2</span>
                </div>
                <div>
                  <h3 className="text-[0.9375rem] font-semibold text-[#eef2ec] mb-1.5">Customer pays the factor</h3>
                  <p className="text-sm text-[#9aaa98] leading-relaxed">
            ...
            {/* Step 3 */}
            <div className="rounded-b-xl border-x border-b border-[#1e2620] bg-[#111512] px-6 py-5">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-[#0a0d0b] border border-[#22c55e]/30 flex items-center justify-center">
                  <span className="text-[0.65rem] font-bold text-[#22c55e] tabular-nums">3</span>
                </div>
                <div>
                  <h3 className="text-[0.9375rem] font-semibold text-[#eef2ec] mb-1.5">Reserve release</h3>
                  <p className="text-sm text-[#9aaa98] leading-relaxed">
          ...
          <div className="mt-8 rounded-xl border border-[#1e2620] bg-[#0a0d0b] px-6 py-5">
            <p className="text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[#6b7e69] mb-4">Illustrative Example — Not a Quote</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Invoice face value</p>
                <p className="text-lg font-semibold text-[#eef2ec] tabular-nums">$50,000</p>
              </div>
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Advance (85%)</p>
                <p className="text-lg font-semibold text-[#22c55e] tabular-nums">$42,500</p>
              </div>
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Reserve held (15%)</p>
                <p className="text-lg font-semibold text-[#eef2ec] tabular-nums">$7,500</p>
              </div>
            </div>
            <div className="border-t border-[#1e2620] pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Factoring fee (2.5%)</p>
                <p className="text-lg font-semibold text-[#eef2ec] tabular-nums">$1,250</p>
              </div>
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Reserve released</p>
                <p className="text-lg font-semibold text-[#22c55e] tabular-nums">$6,250</p>
              </div>
              <div>
                <p className="text-xs text-[#6b7e69] mb-1">Net proceeds (total)</p>
                <p className="text-lg font-semibold text-[#eef2ec] tabular-nums">$48,750</p>
              </div>
            </div>
            <p className="text-xs text-[#6b7e69] mt-4 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.label} className="rounded-xl border border-[#1e2620] bg-[#111512] px-5 py-4">
                <p className="text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[#6b7e69] mb-2">{item.label}</p>
                <p className="text-sm text-[#9aaa98] leading-relaxed">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-14 border-b border-[#1e2620]">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Benefits */}
            <div>
              <p className="text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[#22c55e] mb-4">Potential Benefits</p>
            ...
            {/* Limitations */}
            <div>
              <p className="text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[#6b7e69] mb-4">Limitations to Consider</p>
              <ul className="space-y-3">
                {[
      ...
      <section className="py-10 border-b border-[#1e2620]">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          <div className="rounded-xl border border-[#1e2620] bg-[#111512] px-6 py-6 flex flex-col sm:flex-row sm:items-center gap-5">
            <div className="flex-1">
              <p className="text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[#22c55e] mb-1.5">Calculator</p>
            ...
            <Link
              ...
              className="flex-shrink-0 px-6 py-3 rounded-xl border border-[#1e2620] text-[#eef2ec] text-sm font-medium hover:border-[#22c55e]/60 hover:text-white transition-colors"
            >
              Open Calculator
            </Link>
          </div>
