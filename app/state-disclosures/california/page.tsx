...
function DisclosureItem({
  ...
  return (
    <div className="grid grid-cols-[7rem_1fr] gap-x-5 gap-y-1 border-t border-[#e5e5e5] pt-4">
      <p className="text-[0.6rem] font-semibold uppercase tracking-[0.12em] text-[#a3a3a3] font-mono pt-0.5">
        {label}
      </p>
    ...
    <div className="bg-[#ffffff] min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-5 lg:px-8 py-14">
        ...
        <section aria-labelledby="referral-heading">
          ...
          <ul className="space-y-3 mb-5">
            {[
              ...
              >
                <span
                  className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-[#0f0f0f] opacity-70"
                  aria-hidden="true"
                />
                <span>{item}</span>
              </li>
        ...
        <section aria-labelledby="ccfpl-heading">
          ...
          <div className="rounded-lg border border-[#e5e5e5] bg-[#f5f5f5] p-5 mb-6">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.12em] text-[#a3a3a3] font-mono mb-3">
          ...
          <h3 className="text-base font-semibold text-[#0f0f0f] mb-5">
          ...
          <div className="mt-8 rounded-lg border border-[#e5e5e5] bg-[#f5f5f5] p-5">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.12em] text-[#a3a3a3] font-mono mb-3">
          ...
          <div className="mt-6 rounded-lg border border-[#e5e5e5] bg-[#f5f5f5] p-5">
            <p className="text-[0.6rem] font-semibold uppercase tracking-[0.12em] text-[#a3a3a3] font-mono mb-3">
        ...
        <section aria-labelledby="dfpi-heading">
          ...
          <div className="rounded-lg border border-[#e5e5e5] bg-[#f5f5f5] p-5 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <p className="text-xs text-[#a3a3a3] leading-relaxed mb-8">
