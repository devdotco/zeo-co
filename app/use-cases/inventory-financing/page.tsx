      ...
      <section className="py-14 border-t border-[#1e2620]">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-[#9aaa98] mt-1 max-w-xl">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <Link
                key={link.label}
                href={link.href}
                className="px-4 py-2 rounded-xl border border-[#1e2620] text-sm text-[#9aaa98] hover:text-white hover:border-[#22c55e]/50 transition-colors"
              >
                {link.label}
              </Link>
            ))}
